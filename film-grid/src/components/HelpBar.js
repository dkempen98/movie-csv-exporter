            ...
            {helpModal && (
                <div className='overlay'>
                    <div ref={refOne} className="help-modal">
                        ...
                        <p>Each answer given, right or wrong, will use one of your guesses.</p>
                        <p>Unlike many other grid games, the same movie CAN be used more than once. This is to prevent wrong guesses from making the grid impossible.</p>
                        <h2>About</h2>
